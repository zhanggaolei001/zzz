...
shopid = "1955"  // ##你要商品ID 茅台
shopid1 = "1956"  //##你要商品ID 冰箱
    ...
    return new Promise(async (resolve) => {
        ...
        let options = {
            ...
            headers: {
                ...
                "Host": "m.jingxi.com",
                "User-Agent": "jdpingou;iPhone;5.5.0;14.5;c6a2dd939a8fda6d3020f694e79cf6317714f058;network/wifi;model/iPhone11,2;appBuild/100655;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/346;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148",
                "Cookie": cookie,
            }
        }
...
function list1() {
    return new Promise(async (resolve) => {
        ...
        let options = {
            url: `https://m.jingxi.com/dreamfactory/userinfo/AddProduction?zone=dream_factory&factoryId=1099529662558&deviceId=1099529662559&commodityDimId=${shopid1}&replaceProductionId=&_time=${Date.now()}&_ts=${Date.now()}&_=${Date.now()}&sceneval=2&g_login_type=1&callback=jsonpCBKDD&g_ty=ls`,
                                                                        // zone=dream_factory&factoryId=1099529662558&deviceId=1099529662559&commodityDimId=1951&      replaceProductionId=&_time=           //&_ts=1635474210434&_=1635474210436&sceneval=2&g_login_type=1&callback=jsonpCBKDD&g_ty=ls'  -H 'Host: m.jingxi.com  
            // body: `functionId=HomeZeroBuy&body={"pageNum":1,"channel":"speed_app"}&appid=megatron&client=megatron&clientVersion=1.0.0`,
            headers: {
                "X-Requested-With": "com.jd.pingou",

                "Referer": "https://st.jingxi.com/pingou/dream_factory/index.html?ptag=7155.9.46",
                "Host": "m.jingxi.com",
                "User-Agent": "jdpingou;iPhone;5.5.0;14.5;c6a2dd939a8fda6d3020f694e79cf6317714f058;network/wifi;model/iPhone11,2;appBuild/100655;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/346;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148",
                "Cookie": cookie,
            }
