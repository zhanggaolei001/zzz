/*
*京喜工厂自动开团  
 cron 3 20-23 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_dreamFactory_auto_tuan.js
*成团条件：
*   成团所需人数根据活动所需人数变化，一般为5-7人，
*   若5人成团，则5个CK能成团一次，9个CK能成团两次，13个CK能成团三次
* */
const $ = new Env('京喜工厂自动开团');
            ...
            try {
                if (err) {
                    ...
                    if (safeGet(data)) {
                       ...
                       $.electric=data.data.user.electric
                        if (data['ret'] === 0) {
                            data = data['data'];
